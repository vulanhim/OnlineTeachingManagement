 ...
 * @author LeeBen
 */
public class DeleteOneCourseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean ans = dao.deleteOneCourse(courseID);
            if (ans) {
                    out.println("Delete Course Successful");
                    Message msg = new Message("Delete course successful!", "success", "alert-success");
