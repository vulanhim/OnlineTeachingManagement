<%-- 
    Document   : Search
    Created on : Jan 8, 2022, 11:26:48 PM
    Author     : LeeBen
--%>
...
<html lang="en" dir="ltr">
    ...
    <body>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="list-group">
                                    ...
                                    <%
                                        ...
                                        List<User> listUser = ud.getUserByDepartmentID(user.getDepartmentID());
                                        for (User uu : listUser) {
                                    %>
                                    <a href="#" onclick="getCourses(<%= uu.getUserID()%>, this)" class=" c-link list-group-item list-group-item-action" style="border-color: #d2d1d6">
                                        <%= uu.getName()%>
                                    </a>
                                    <%
                                        }
        ...
        <script>
            function getCourses(userID, temp) {
                $("#loader").show();
                $(".c-link").removeClass('active');
                $(".c-link").css({"background-color": "white", "font-weight": "400"});
                $.ajax({
